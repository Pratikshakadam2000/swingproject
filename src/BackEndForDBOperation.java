...
public class BackEndForDBOperation 
{
	...
	public ArrayList<UserModel> searchstudentrecord(String emailid)
	{
		  ...
		  try
		  {
	        ...
	        String fetchallquery = "select * from userdetails where email=?";
	...
	public int updateRecord(UserModel userobj)
	{
	   ...
	   try
	   {
	      ...
	      {
	   		e.printStackTrace();
	   		System.out.println("Can't Update Record - Database Problem");
	      }
	      finally 
	      {
	       	try 
